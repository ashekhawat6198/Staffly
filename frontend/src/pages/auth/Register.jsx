    ...
    <div className="min-h-screen flex font-sans">
      ...
      <div className="w-full lg:w-1/2 bg-[#FAF9F6] flex items-center justify-center p-8">
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          ...
          <h2 className="font-['Space_Grotesk'] font-medium text-2xl text-[#14171F] mb-1">Create account</h2>
          <p className="text-gray-500 text-sm mb-8">Set up your access to get started</p>
          ...
          <div className="mb-6">
            <label className="block text-sm font-medium text-[#14171F] mb-1.5">Role</label>
            <select
              value={role}
              onChange={(e) => setRole(e.target.value)}
              className="w-full border border-gray-300 rounded-lg px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#4F5DFF] focus:border-transparent transition bg-white"
            >
          ...
          <p className="text-sm text-center mt-6 text-gray-500">
            ...
            <Link to="/login" className="text-[#4F5DFF] font-medium hover:underline">Sign in</Link>
          </p>
        </form>
      </div>
    </div>
